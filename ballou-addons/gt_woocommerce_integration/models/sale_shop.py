...
class SaleShop(models.Model):
    ...
    def woocomManageOrderLines(self, orderid, order_detail, wcapi):
        ...
        for child in order_detail.get('line_items'):
            ...
            if child.get('subtotal_tax') != None:
                ...
                tax_id = self.getTaxesAccountID(child)
                # print("tax_idddddddddddddddddddddd",tax_id)

                if not tax_id:
                    # print ("taxxxxxxidddddddddddddd",tax_id)
                    line['tax_id'] = [(6, 0, [tax_id[0].id])]
    ...
    def create_woo_order(self, order_detail, wcapi):
        ...
        # if order_vals['order_status'] == 'gplsquote-req':
        #     order_vals['order_status'] = 'pending'
        ...
        for shop in self:
            ...
            for tag in tag_ids:
                data = {
                    ...
                    'slug': tag.slud_code,
                    'id': tag.tag_id,
                    'description': tag.descimportWoocomCustomerription,
                }
