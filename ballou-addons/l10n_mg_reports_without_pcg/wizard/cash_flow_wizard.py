...
class CashFLowWizard(models.TransientModel):
    ...
    def confirm_cash_flow_view(self):
        ...
        memo = self.env.ref('l10n_mg_reports_without_pcg.indirect_flux_tresorerie_report_html').report_action(self, data=data)
        return memo
    ...
    def print_pdf(self):
        ...
        return self.env.ref('l10n_mg_reports_without_pcg.indirect_flux_tresorerie_report').report_action(self, data=data)
