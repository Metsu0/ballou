...
class EvcpReportViewWizard(models.TransientModel):
    ...
    def confirm_evcp_view(self):
        ...
        memo = self.env.ref('l10n_mg_reports_without_pcg.evcp_report').report_action(self, data=data)
        return memo
    ...
    def print_xlsx(self):
        ...
        temp_data = self.env.ref('l10n_mg_reports_without_pcg.evcp_report').report_action(self, data=temp_data,
                                                                                                 config=False)
        data = {
    ...
    def get_xlsx_report(self, data, response):
        report = self.env['report.l10n_mg_reports_without_pcg.evcp_report_template']
