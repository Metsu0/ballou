...
odoo.define('ks_dashboard_ninja.ks_dashboard', function (require) {
    ...
    var KsDashboardNinja = AbstractAction.extend( {
        ...
        jsLibs: ['/ks_dashboard_ninja/static/lib/js/jquery.ui.touch-punch.min.js',
            ...
            '/ks_dashboard_ninja/static/lib/js/stack.min.js',
        ...
        ksRenderChartColorOptions: function (e) {
            ...
            if (!$(e.currentTarget).parent().hasClass('ks_date_filter_selected')) {
                ...
                this.ksChartColors(e.currentTarget.dataset.chartColor, this.chart_container[$parent.data().itemId], $parent.data().chartType, $parent.data().chartFamily, item_data.ks_bar_chart_stacked, item_data.ks_semi_circle_chart, item_data.ks_show_data_value)
                this._rpc({
...
//            ".ks_date_input_fields"
        ...
        _renderGraph: function (item, grid) {
            ...
            if (chart_data && chart_data["datasets"].length > 0) self.ksChartColors(item.ks_chart_item_color, ksMyChart, chart_type, chart_family, item.ks_bar_chart_stacked, item.ks_semi_circle_chart, item.ks_show_data_value);
        ...
        _ksSaveCurrentLayoutLocally: function () {
            ...
            self.ks_dashboard_data.ks_gridstack_config = JSON.stringify(grid_config);
            var item_update_needed = !(Object.keys(self.ks_dashboard_data.ks_item_data).every((x) => {
                return grid_config.hasOwnProperty(x)
            }));
